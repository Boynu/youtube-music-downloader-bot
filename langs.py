...
menu = {'RU':'🎵🔗Отправте ссылку на музыку или плейлист (Из youtube.com или music.youtube.com)\nВы можете указать несколько песен через пробел\n\n📰Справка /help', 'EN':'🎵🔗Send a link to the music or playlist (From youtube.com or music.youtube.com )\nYou can specify multiple songs separated by a space\n\n📰Help /help'}

default = {'RU':'ПЛЕЙЛИСТ ПО УМОЛЧАНИЮ', 'EN':'DEFAULT PLAYLIST'}

ch_play = {'RU':'👇Укажите в какой плейлист вы хотите загрузить песни', 'EN':'👇 Specify which playlist you want to upload songs to'}
...
err_min = {'RU':'длится более 30 минут!', 'EN':'lasts more than 30 minutes!'}
err_age = {'RU':'❌Видео имеет возрастные ограничения и не может быть доступно без OAuth', 'EN':'❌The video has age restrictions and cannot be accessed without OAuth'}
err_live = {'RU':'❌Это прямая трансляция', 'EN':'❌This is a live broadcast'}
err_region = {'RU':'❌Регион сервера не позволяет скачать песню!', 'EN':'❌The server region does not allow you to download the song!'}
err_ava = {'RU':'❌Видео недоступно!', 'EN':'❌Video is not available!'}
err_name = {'RU':'❌Такой плейлист уже существует!', 'EN':'❌Such a playlist already exists!'}
err_p = {'RU':'❌Ошибка. Вы указали неправильное название плейлиста', 'EN':'❌Error. You have entered the wrong playlist name'}
